...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="../public/images/ico/apple-icon-60.png">
    <link rel="apple-touch-icon" sizes="76x76" href="../public/images/ico/apple-icon-76.png">
    <link rel="apple-touch-icon" sizes="120x120" href="../public/images/ico/apple-icon-120.png">
    <link rel="apple-touch-icon" sizes="152x152" href="../public/images/ico/apple-icon-152.png">
    <link rel="shortcut icon" type="image/x-icon" href="../public/images/ico/favicon.ico">
    <link rel="shortcut icon" type="image/png" href="../public/images/ico/favicon-32.png">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="<?= (isset($noMenu) || $noMenu == true) ? '1-columns  blank-page blank-page ' : 'vertical-layout vertical-menu 2-columns fixed-navbar '; ?>">